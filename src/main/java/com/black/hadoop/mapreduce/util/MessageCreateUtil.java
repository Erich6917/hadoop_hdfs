package com.black.hadoop.mapreduce.util;
...
//		String msg = String.format("%s %s %s %s %s", name, id, month, flowUp, flowDown);
//		System.out.println(msg);
		writeRandomMsg();
	}

	private static void writeRandomMsg() {
		int total = 1000;
