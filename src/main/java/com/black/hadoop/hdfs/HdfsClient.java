...
//		conf.set("fs.defaultFS", "hdfs://192.168.100.120:9000");
		 ...
		 */
		// 获取一个hdfs的访问客户端
		fs = FileSystem.get(new URI("hdfs://192.168.100.120:9000"), conf, "root");
	}
	...
	public void testAddFileToHdfs() throws Exception {
		...
		// 要上传到hdfs的目标路径*/
		Path src = new Path("C:\\Data\\pdf\\pdf.txt");
		Path dst = new Path("/");
	...
	public void testDownloadFileToLocal() throws IllegalArgumentException, IOException {
		...
		// Path("d:/"));
		fs.copyToLocalFile(false, new Path("/pdf.txt"), new Path("C:\\Data\\hadoop"), true);
		fs.close();
